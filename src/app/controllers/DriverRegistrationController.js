...
const DriverRegistrationController = {
    async RefuseRegistrationAction(req, res){
        ...
        const title = 'driver registration refused'
        const content = `Hello, I am the admin of Cyber Go, Your driver registration was rejected for the following reason: ${refuse_reason} License plates:`
        ...
        if(result_refuse === StatusCode.NOT_FOUND){
            ...
            return res.status(200).json({code: StatusCode.OK, message: 'Driver registration has been refused'})
        }
    ...
    async AcceptRegistrationAction(req, res){
        ...
        const title = 'driver registration accepted'
        const content = 'Hello, I am the admin of Cyber Go, your driver registration has been approved and you can share your trip now. License plates:'
        ...
        if(result_accept === StatusCode.NOT_FOUND){
            ...
            return res.status(200).json({code: StatusCode.OK, message: 'Driver registration has been accepted'})
        }
        return res.status(200).json({code: StatusCode.BAD_REQUEST, message: 'Something went wrong!'})
    },
