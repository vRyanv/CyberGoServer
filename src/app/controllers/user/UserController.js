const {StatusCode, ErrorType} = require('../../constant')
...
const UserController = {
    ...
    DriverRegistrationAction(req, res){
    ...
    async UpdateProfileAction(req, res){
       ...
       if(update_result){
        if(update_result.avatar){
            return res.status(200).json({code: StatusCode.UPDATED, avatar: update_result.avatar, message: 'Updated profile success'})
        }
