...
const key = require('../../secret/cyber-go-key.json');
const fs = require('fs');
...
const googleDriveService = {
  ...
  uploadFile: async (fileName, fileType, folder, __path) => {
    try {
      ...
      let link = await googleDriveService.setFilePublic(createFile.data.id);
...
googleDriveService.deleteFile('1wHdLOvZ3X6Nq_J6gRAUb4x0oUbV3PE4K')
